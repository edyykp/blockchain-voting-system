...
import { StandingsModal, VotingModal } from '@packages/core';
...
export const Card = ({ race }: CardProps) => {
  ...
  const [standingsShow, setShowStandingsModal] = useState(false);
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.body}>
        ...
        <button
          className={`${styles.button} ${styles.standingsButton}`}
